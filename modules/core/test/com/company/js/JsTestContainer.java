...
public class JsTestContainer extends TestContainer {

    public JsTestContainer() {
        super();
    ...
    public static class Common extends JsTestContainer {

        public static final JsTestContainer.Common INSTANCE = new JsTestContainer.Common();
